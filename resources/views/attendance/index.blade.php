    ...
    <main class="container">
        <div class="panel">
            <div class="panel-header">
                ...
                <p>Complete historical logs of your self-marked attendance status.</p>
            </div>
                        ...
                        @forelse($attendances as $attendance)
                            <tr>
                                <td style="font-weight: 500; color: var(--text-primary);">
                                    {{ $attendance->attendance_date->format('l, M d, Y') }}
                                </td>
                                <td>
                                ...
                                <td>{{ $attendance->created_at->setTimezone(config('app.timezone', 'UTC'))->format('h:i A') }}</td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="4" style="text-align: center; padding: 40px 0; color: var(--text-secondary);">
                                    No attendance records found. Mark your attendance from the dashboard!
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
